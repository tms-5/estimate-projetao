...
import TaskCard from "@/lib/components/appComponents/task/TaskCard";
          ...
          typeof user !== "string" && (
            <Sidebar user={user!}>
              ...
              <div className="w-fit ml-2r">
                ...
                <div className="bg-space-blue-100 b-3 w-80" style={{height: 3, marginTop: -10}}/>
              </div>
              <div className="w-100 mt-1r">
                  <TaskCard id={""} nome={"Login"} descricao={"Criar tela de login"} projeto_id={""} avaliacoes={7} />
              </div>
              <div className="w-fit ml-2r">
