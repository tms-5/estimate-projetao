  ...
  return (
    <>
      ...
      >
        ...
        >
          <InputProjectRegister name="Nome" onChange={(e) => handleInputChange(e.target.value, "name")} />
          ...
          <InputProjectRegister name="Área" onChange={(e) => handleInputChange(e.target.value, "company_field")}/>
          <InputProjectRegister name="Tecnologia" onChange={(e) => handleInputChange(e.target.value, "description")}/>
          <p style={{ marginBottom: "4px", width: "100%" }}>Bibliotecas</p>
          <ChipsArray onChangeValues={(values: string[]) => handleInputChange(Array.from(values).join(', '), "stack")} />
        </div>
      </div>
